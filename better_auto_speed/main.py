...
from .endstop_accuracy import EndstopAccuracyMixin

class BetterAutoSpeed(OverridesMixin, EndstopAccuracyMixin):
    ...
    def _home(self, x=True, y=True, z=True):
        ...
        if z:
            command[-1] += " Z0"
        self.gcode.run_script_from_command(command[0])
        self.toolhead.wait_moves()
